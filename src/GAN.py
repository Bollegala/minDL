"""
A minimal example of using GANs to model Gaussians
...
axes.set_ylim(-1, 8)
line1, = axes.plot(xdata, y1data, 'b.')

plt.subplot(212)
axes = plt.gca()
axes.set_xlim(0, num_epochs)
axes.set_ylim(-2, 4)
line2, = axes.plot(xdata, y2data, 'r.')
...
for epoch in range(num_epochs):
    ...
    xdata.append(epoch)
    y1data.append(stats(extract(d_fake_data))[0])
    y2data.append(stats(extract(d_fake_data))[1])
